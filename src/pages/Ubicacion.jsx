      ...
      <div className="relative z-10 flex flex-col items-center pt-32 pb-16 px-4 md:px-8">
        <div className="text-center space-y-6 max-w-4xl">
          <div className="inline-flex items-center gap-3 bg-linear-to-r from-accgreenlight/20 to-accblue/20 px-6 py-3 rounded-full border border-acclight/30">
            <svg className="w-5 h-5 text-accgreendark" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
            </svg>
            <span className="text-sm font-medium text-accgray">Carretera Austral Km 21.8</span>
          </div>
          ...
          <p className="text-lg/7 md:text-xl/7 text-accgray/80 max-w-2xl mx-auto">
            Estamos ubicados en el inicio de la hermosa Carretera Austral, a tan solo 25 minutos de Puerto Montt.
          </p>
          <SectionHeaderDesign />
        </div>
        ...
        <div className="w-full max-w-7xl mt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 place-items-center">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex gap-4">
                    <span className="shrink-0 w-6 h-6 rounded-full bg-accgreenlight/20 text-accgreendark text-xs font-bold flex items-center justify-center">{index + 1}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-linear-to-br from-accblue/10 to-accgreenlight/10 p-6 rounded-3xl border border-white/40 shadow-lg">
                <h3 className="font-bold text-accgray mb-2 flex items-center gap-2">
                  <svg className="w-5 h-5 text-accblue" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" /></svg>
                  Transporte Público
                </h3>
                <p className="text-sm text-accgray/70">
                  Toma las líneas <strong>Buses Vargas</strong> o <strong>Buses J.B.</strong> desde el <a href="https://terminalpm.cl/" className="underline">Terminal de Buses</a>. Salidas frecuentes hacia Caleta La Arena; solicita bajar en <strong>Quillaipe</strong>.
                </p>
              </div>
          ...
          <div className="col-span-2 w-full max-w-7xl mt-8 ">
